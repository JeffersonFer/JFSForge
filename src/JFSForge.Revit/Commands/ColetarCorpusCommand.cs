...
using JFSForge.Core.Domain.Corpus;
using JFSForge.Revit.Domain;
using JFSForge.Revit.Domain.Corpus;
using JFSForge.Revit.Domain.SelectionFilters;
...
namespace JFSForge.Revit.Commands
{
    ...
    internal class ColetarCorpusCommand : IExternalCommand
    {
        ...
        private List<PontoDeParede> ObterPontosDeParede(Autodesk.Revit.DB.Document document, Wall paredeAlvo)
        {
        ...
        private bool VerificarAmarracao(Autodesk.Revit.DB.Document document, Wall parede, XYZ ponto, double alturaZCm)
        {
        ...
        private List<BlocoDetectado> DetectarBlocosDoTrecho(Autodesk.Revit.DB.Document document, Wall parede, XYZ pontoInicio, XYZ pontoFim, double alturaZCm)
        {
        ...
        private TrechoDados MontarTrechoDados(Autodesk.Revit.DB.Document document, Wall parede, TrechoBruto trecho)
        {
